...
chef = db.relationship('Chef', back_populates='usuario', uselist=False, cascade="all,
delete-orphan")
...
chef_id = db.Column(db.Integer, db.ForeignKey('chef.id'), nullable=False) # Continua
apontando para Chef

Prof. Alexandre Bendlin Pág. 2
